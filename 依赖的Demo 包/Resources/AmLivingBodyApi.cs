...
namespace EXCResources
{
    public class AmLivingBodyApi
    {
        ...
        ///     设置显示视频的窗口句柄及显示区域
        /// </summary>
        /// <param name="hwnd">显示视频的窗口句柄</param>
        ...
        /// </summary>
        /// <returns>=AM_E_SUCCESS 表示成功，<0表示错误码</returns>
        [DllImport("C:\\Program Files (x86)\\AuthenMetric\\LivingBody\\bin\\LibLivingBody.dll", EntryPoint = "AmOpenDevice", CallingConvention = CallingConvention.StdCall)]
        public static extern int AmOpenDevices();

        private static string DLLPath = @"C:\Program Files (x86)\AuthenMetric\LivingBody\bin\LibLivingBody.dll";
        ...
        ///关闭设备
        /// </summary>
        /// <returns>=AM_E_SUCCESS 表示成功，<0表示错误码</r  eturns>
        [DllImport("C:\\Program Files (x86)\\AuthenMetric\\LivingBody\\bin\\LibLivingBody.dll", EntryPoint = "AmCloseDevice", CallingConvention = CallingConvention.StdCall)]
        ...
        /// <returns>返回值：>0表示两张图片比对的相似度，<0表示错误码</returns>
