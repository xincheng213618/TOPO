    ...
    public partial class Pdfshow : Page
    {
        ...
        public Pdfshow(string filePath, int PrintAllNum = 200, bool AllowPrint = true)
        {
            ...
            Thread thread = new Thread(new ThreadStart(() =>
            {
                ...
                keybd_event(System.Windows.Forms.Keys.L, 0, 0, 0);
        ...
        private void OpenPDF(string PDFpath)
        {
            try
            {
                ...
                if (PageAllNum != 0)
                {
                    ...
                    dy.Visibility = Button1.Visibility;
                    Button2.Visibility = AllowPrint && PageAllNum >999 ? Visibility.Visible : Visibility.Hidden;
                   //首页
                    Button3.Visibility = PageAllNum <= 1 ? Visibility.Hidden : Visibility.Visible;
                    sy.Visibility = Button3.Visibility;
                    //尾页
                    wy.Visibility = Button4.Visibility;
        ...
        private void formsHost_MouseLeave(object sender, MouseEventArgs e)
        {
        }

        private void Image_MouseDown(object sender, MouseButtonEventArgs e)
        {
            string str = ((Image)sender).Name;
            switch (str)
            {
                case "zy":
                    Content = new HomePage();
